...
import GIPHY_KEY from '../secrets/giphy-key.js';
...
export default function notImplemented(state) {
  //throw new Error(`SuccessPayment is not implemented as a standard, stand-alone view`);
  return SuccessPayment(state);
}

export async function SuccessPayment(state) {
  ...
  return `
    <html lang=en>
      ...
      <script type=module>
        import {init} from '/${DEBUG.BUILD}/success.js';
