...
const Nav = [
  ...
  {href:'https://github.com/c9fe/ViewFinder', text: "VF Docs"},
  {href:'/form/selection/archivist1', text: "Archivist1"},
      ...
      section ${{class:'content'}} ${"content"},
        section ${{id:'how', class:'card-stack'}} ${"section"},
          section ${{class:'transparent'}} ${"card"},
            ...
            p,
              a ${{
                href:'https://demo.browsergap.dosyago.com', target:"_blank", 
                title:"Click through to a free live demo"
              }},
                img ${{
          ...
          .
          section ${{class:'transparent'}} ${"card"},
            h1 ${{style:"font-size: 3.5vw; text-align: right;"}} :text ${"ViewFinder is a secure browser you embed in your webapp."}.
          .
        .
        section ${{class:'awesome'}} ${"section"},
          h1 ${"Why ViewFinder is Awesome"}.
          ...
          h1 ${"Frequently Asked Questions"}.
            section ${{class:'block'}} ${"card"},
              dl,
                ...
                dd,
                  :text ${"Please, "}.
                  a ${{href:'mailto:cris@dosycorp.com?body=Hi%20Cris&subject=ViewFinder%20Help'}} :text ${"mail me"}.
                  :text ${" for assistance."}.
                .
              .
            .
