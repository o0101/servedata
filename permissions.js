...
const Perms = [
  ...
  // permissions for standard auth actions signup, login, logout
    ...
    [
      `${NOUSER_ID}:selection/login`,
      {
        view:true, 
      }
    ],
    [
      `${NOUSER_ID}:selection/signup`,
      {
        view:true, 
      }
    ],
    [
      `${NOUSER_ID}:selection/email-login`,
      {
        view:true, 
      }
    ],
    [
      `${NOUSER_ID}:selection/archivist1`,
      {
        view:true, 
      }
    ],
    ...
    [
      `group/users:selection/archivist1`,
      {
        view:true, 
      }
    ],
    ...
    [
      `group/users:selection/login`,
      {
        view:true, 
      }
    ],
    [
      `group/users:selection/signup`,
      {
        view:true, 
      }
    ],
    [
      `group/users:selection/email-login`,
      {
        view:true, 
      }
    ],
